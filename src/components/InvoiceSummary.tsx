    ...
    <Card className="w-full shadow-lg rounded-2xl">
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <Input value="100% Advance - Account No: EG230014002300001029355429202" readOnly />
        </div>
        ...
        <div>
          ...
          <Input value="Account No: EG230014002300001029355429202" readOnly className="text-sm font-mono" />
          
          <Label>Payment Instructions</Label>
          <Input value="Transfer to Account: EG230014002300001029355429202" readOnly className="text-sm" />
        </div>
